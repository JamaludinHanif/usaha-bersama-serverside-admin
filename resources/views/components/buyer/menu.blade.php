<nav class="sticky top-0 z-50 bg-white shadow border-b-2">
                    ...
                    <div class="hidden md:ml-4 md:flex md:shrink-0 md:items-center">
                        ...
                        <div class="relative ml-3">
                            ...
                            <div id="profil-dropdown"
                                ...
                                <a href="{{ route('buyer.logout') }}" class="block px-4 py-2 text-sm text-gray-700"
    ...
    <div class="transition-all duration-300 transform opacity-0 scale-95 hidden shadow-lg" id="mobile-menu">
        <div class="space-y-1 pb-3 pt-2">
            ...
            <a
                href="{{ route('buyer.index') }}"class="block border-l-4 py-2 pl-3 pr-4 text-base font-semibold sm:pl-5 sm:pr-6 {{ request()->url() == route('buyer.index') ? 'bg-indigo-50 border-indigo-500 font-bold text-indigo-700' : 'border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700' }}">
                Beranda
            </a>
            <a
                href="{{ route('buyer.history') }}"class="block border-l-4 py-2 pl-3 pr-4 text-base font-semibold sm:pl-5 sm:pr-6 {{ request()->url() == route('buyer.history') ? 'bg-indigo-50 border-indigo-500 font-bold text-indigo-700' : 'border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700' }}">
                Riwayat Pembelian
            </a>
        </div>
        ...
        @if (session('userData'))
            <div class="border-t border-gray-200 pb-3 pt-4">
                <div class="flex items-center px-4 sm:px-6">
                    <div class="shrink-0">
                        <img class="size-10 rounded-full" src="{{ asset('user-avatar.jpg') }}" alt="">
                    </div>
                    <div class="ml-3">
                        <div class="text-base font-medium text-gray-800">{{ session('userData')->name }}</div>

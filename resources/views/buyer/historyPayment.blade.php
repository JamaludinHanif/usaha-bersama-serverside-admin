                                ...
                                <div aria-labelledby="">
                                    <div class="space-y-1 md:flex md:items-baseline md:space-x-4 md:space-y-0">
                                        ...
                                        <div
                                            ...
                                            <p class="text-xs font-medium text-gray-500">Dibeli Pada Tanggal
                                                {{ $transaction->created_at->translatedFormat('d F Y') }}</p>
                                            <div class="flex text-sm font-medium">
                                                <a href="#" class="text-indigo-600 hover:text-indigo-500">Detail
                                                    Pembelian</a>
                                    ...
                                    <div class="-mb-6 flow-root divide-y divide-gray-200 ">
